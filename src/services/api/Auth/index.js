...
export const changePassword = (token, data) => Post('auth', `client-user/change-password`, data, token);
...
export const userCompanyInfo = (token) => Get('auth', 'client-user/company-info', token)